...
const ROUTE_MAP: Record<string, [string, string]> = {
    ...
    "/follow-up":                         ["Care & Outreach", "Follow Up"],
    "/evangelism":                        ["Care & Outreach", "Evangelism"],
    "/prayer-requests":                   ["Care & Outreach", "Prayer Requests"],
    "/pastor-feedback":                    ["Care & Outreach", "Pastor Feedback"],
    "/profile":                           ["",          "My Profile"],
    "/departments":                       ["Ministry",  "Departments"],
    "/classes":                           ["Ministry",  "Training Classes"],
    "/classes/types":                     ["Ministry",  "Training Class Types"],
    ...
    "/admin-management":                  ["System",    "Admin Users"],
