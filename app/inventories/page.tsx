        ...
        <div className="lg:col-span-5 bg-[#FFFFFF] border border-[#121212]/10 rounded-xl overflow-hidden flex flex-col">
            ...
            <div className="p-5 space-y-5 overflow-y-auto flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-3">
                        ...
                        {asset.purchaseDate && <div><p className="text-[11px] font-semibold uppercase tracking-widest text-[#8A817C]">Purchased</p><p className="text-sm text-[#121212] font-light mt-0.5">{new Date(asset.purchaseDate + "T00:00:00").toLocaleDateString()}</p></div>}
